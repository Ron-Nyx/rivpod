...
class SomeWidget extends StatefulWidget {
  ...
  @override
  State<SomeWidget> createState() => _SomeWidgetController();
}

class _$SomeWidgetController extends State<SomeWidget> {
  @override
  Widget build(BuildContext context) {
    return const _SomeWidgetView();
  }
...
class _SomeWidgetController extends _$SomeWidgetController {
 
 
}

class _SomeWidgetView extends StatelessWidget {
  const _SomeWidgetView(this.state, {super.key});

  final _SomeWidgetController state;
